...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread threadA = createThread('a', queueA);
        Thread threadB = createThread('b', queueB);
        Thread threadC = createThread('c', queueC);
    ...
    public static Thread createThread(char letter, ArrayBlockingQueue<String> queue) {
        return new Thread(() -> {
            long maxLength;
            try {
